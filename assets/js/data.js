...
const projectImageSets = {
  "octoclick": locals(
    ...
    "case-octoclick/1.mov",
    "case-octoclick/Group 1.jpg",
    "case-octoclick/Group 2.jpg",
    "case-octoclick/Group 3.jpg",
    "case-octoclick/Group 4.jpg",
    "case-octoclick/Group 5.jpg",
    "case-octoclick/Group 6.jpg",
    "case-octoclick/Group 7.jpg",
    "case-octoclick/Group 8.jpg",
    "case-octoclick/Group 9.jpg",
    "case-octoclick/Group 10.jpg",
    "case-octoclick/Group 11.jpg",
    "case-octoclick/image 2.jpg",
    "case-octoclick/image 3.jpg",
    "case-octoclick/image 10.jpg",
    "case-octoclick/image 12.jpg",
    "case-octoclick/image 15.jpg"
  ),
  ai: locals(
  ...
  "pazl-kod-platform": locals(
    "assets/images/сайты/PAZL KOD Platform/Hero.png",
    "assets/images/сайты/PAZL KOD Platform/Hero.png",
    "assets/images/сайты/PAZL KOD Platform/1000017611.png",
    "assets/images/сайты/PAZL KOD Platform/1000017612.png",
    "assets/images/сайты/PAZL KOD Platform/Frame 1321316825.png",
    "assets/images/сайты/PAZL KOD Platform/П2 1.png",
    "assets/images/сайты/PAZL KOD Platform/П3 1.png",
    "assets/images/сайты/PAZL KOD Platform/П4 1.png",
    "assets/images/сайты/PAZL KOD Platform/П5 1.png",
    "assets/images/сайты/PAZL KOD Platform/П6 1.png",
    "assets/images/сайты/PAZL KOD Platform/П7 1.png"
  ),
  "in-it": locals(
    "assets/images/сайты/IN IT/HERO.png",
    "assets/images/сайты/IN IT/HERO.png",
    "assets/images/сайты/IN IT/Frame 2147223682.jpg",
    "assets/images/сайты/IN IT/Frame 2147223712.png",
    "assets/images/сайты/IN IT/Frame 2147223713.png",
    "assets/images/сайты/IN IT/Frame 2147223714.png",
    "assets/images/сайты/IN IT/Frame 2147223715.png",
    "assets/images/сайты/IN IT/Frame 2147223716.png",
    "assets/images/сайты/IN IT/Frame 2147223722.png",
    "assets/images/сайты/IN IT/Frame 2147223723.png",
  ...
  "volt-pay": locals(
    "assets/images/платформы/VOLT PAY/HERO.svg",
    "assets/images/платформы/VOLT PAY/Frame 2147223982.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223983.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223984.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223985.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223987.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223988.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223989.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223990.jpg",
    "assets/images/платформы/VOLT PAY/Frame 2147223991.jpg"
  ),
  "logo-it-school": locals(
    "case-logo-IT school/HERO.jpg",
    "case-logo-IT school/234.jpg",
    "case-logo-IT school/235.jpg",
    "case-logo-IT school/236.jpg",
    "case-logo-IT school/5.6.jpg"
  ),
  "potok": locals(
    "case-potok/HERO.jpg"
  ),
  "logo-pazl-kod": locals(
    "case-logo-PAZL KOD/1000017610.jpg",
    "case-logo-PAZL KOD/Brand guidelines - 5.png",
    "case-logo-PAZL KOD/Brand guidelines - 6.png"
  ),
  "zaozernaya": locals(
...
const featuredProjects = [
  {
    id: "octoclick",
    title: "Octoclick",
    subtitle: "Аналитика и управление рекламой",
    image: projectImageSets["octoclick"][0]
  },
  {
    id: "visiflow",
    title: "VISI FLOW",
    subtitle: "AI‑конвертация строительных проектных документов",
    description:
  ...
  },
  {
    id: "mirox",
    title: "MIROX",
    subtitle: "SaaS для брендов и креаторов",
    description:
      "SaaS‑платформа, которая соединяет бренды и креаторов для запуска рекламных кампаний: от брифа и AI‑подбора исполнителей до публикации контента, отчётов и постоплаты за результат.",
...
const projects = [
  {
    id: "visiflow",
    title: "VISI FLOW",
    subtitle: "AI‑платформа обработки строительной документации",
    category: "uxui",
    description:
    ...
    caseKey: "visiflow",
    casePage: "/case-visiflow"
  },
  {
    id: "octoclick",
    title: "Octoclick",
    subtitle: "AdTech‑платформа аналитики и управления кампаниями",
    description:
    ...
    caseKey: "octoclick",
    casePage: "/case-octoclick"
  },
  {
    id: "mirox",
    title: "MIROX",
    subtitle: "SaaS‑платформа для брендов и креаторов",
    description:
    ...
    metrics: [
      "Сокращение времени от брифа до запуска кампании",
      "Рост прозрачности статусов на каждом этапе",
      "Снижение операционной нагрузки на менеджеров"
    ],
    caseKey: "mirox",
    casePage: "/case-mirox",
    category: "uxui",
  ...
  },
  {
    id: "ai",
    title: "AI",
    subtitle: "Консоль AI‑ассистента для запросов",
    description:
  ...
  },
  {
    ...
    casePage: "/case-pazl-kod-platform",
    category: "uxui",
  ...
  },
  {
    id: "winglish",
    title: "WINGLISH",
    subtitle: "Образовательная платформа изучения английского",
    description:
    ...
    caseKey: "winglish",
    casePage: "/case-winglish"
  },
  {
    id: "nok",
    title: "NOK",
    subtitle: "UX/UI и сайт образовательной онлайн‑платформы NOK",
    description:
  ...
  },
  {
    id: "space-camp",
    title: "SPACE CAMP",
    subtitle: "Сайт детского научного лагеря",
    description:
    ...
    caseKey: "space-camp",
    casePage: "/case-space-camp"
  },
  {
    id: "iss",
    title: "ISS",
    subtitle: "Корпоративный сайт продукта ISS",
    description:
  ...
  },
  {
    id: "profi",
    title: "PROFI",
    subtitle: "Онлайн‑обучение новым IT‑профессиям",
    description:
  ...
  },
  {
    id: "solomadom",
    title: "SOLOMADOM",
    subtitle: "Сайт строительной компании домов",
    description:
    ...
    caseKey: "solomadom",
    casePage: "/case-solomadom"
  },
  {
    id: "amazon",
    title: "AMAZON",
    subtitle: "E‑commerce платформа для магазинов",
    description:
    ...
    caseKey: "amazon",
    casePage: "/case-amazon"
  },
  {
    id: "castle-music",
    title: "CASTLE MUSIC",
    subtitle: "Сайт музыкального проекта Castle",
    description:
    ...
    caseKey: "castle-music",
    casePage: "/case-castle-music"
  },
  {
    id: "kvatro",
    title: "KVATRO",
    subtitle: "Промо‑сайт цифрового сервиса KVATRO",
    description:
    ...
    caseKey: "kvatro",
    casePage: "/case-kvatro"
  },
  {
    id: "leki-travel",
    title: "LEKI TRAVEL",
    subtitle: "Сайт туристического сервиса LEKI",
    description:
    ...
    caseKey: "leki-travel",
    casePage: "/case-leki-travel"
  },
  {
    id: "vihlop-expert",
    title: "VIHLOP EXPERT",
    subtitle: "Автосервис и онлайн‑запись к сервису",
    description:
    ...
    caseKey: "vihlop-expert",
    casePage: "/case-vihlop-expert"
  },
  {
    id: "weintek-panel",
    title: "WEINTEK PANEL",
    subtitle: "HMI / панель оператора",
    description:
      "Интерфейс панели оператора для промышленного оборудования: быстрый доступ к параметрам, предсказуемая навигация и безопасные сценарии при сбоях.",
    timeline: [
      { title: "Сценарии и ограничения", period: "2024" },
      { title: "Информационная структура", period: "2024" },
      { title: "UI и состояния", period: "2025" },
      { title: "Согласование и передача", period: "2025" }
    ],
    calendarRange: {
      startMonth: 0,
      months: 12,
    ...
    technologies: ["HMI", "Industrial UI", "Alerts", "Safe actions"],
    tools: ["Figma", "FigJam", "Notion"],
    metrics: [
      "Сокращение времени реакции на критические алерты",
      "Снижение ошибочных действий при переключении режимов",
      "Рост уверенности операторов при редких сценариях"
    ],
    category: "uxui",
  ...
  },
  {
    id: "volt-pay",
    title: "VOLT PAY",
    subtitle: "Fintech: платежи, кошелёк и мобильное приложение",
    category: "uxui",
    description:
      "UX/UI для платёжного продукта: сценарии пополнения и переводов, прозрачные статусы операций, раздел кошелька и онбординг с упором на доверие и скорость. Проектировал плотные, но читаемые экраны под регуляторные и продуктовые ограничения.",
    timeline: [
      { title: "Карта сценариев и ограничений", period: "10 дней" },
      { title: "IA и ключевые потоки", period: "14 дней" },
      { title: "UI‑система и состояния", period: "21 день" },
      { title: "Итерации и передача в разработку", period: "14 дней" }
    ],
    calendarRange: {
      startMonth: 0,
      months: 12,
    ...
    technologies: ["Fintech", "Payments", "Mobile app", "KYC/AML UI"],
    tools: ["Figma", "FigJam", "Notion"],
    metrics: [
      "Сокращение времени до успешного платежа",
      "Рост завершённых сценариев без обращения в поддержку",
      "Снижение ошибок на шагах ввода и подтверждения"
    ],
    image: projectImageSets["volt-pay"][0],
    gallery: projectImageSets["volt-pay"].slice(1),
    caseKey: "volt-pay",
    casePage: "/case-volt-pay"
  },
  {
    id: "potok",
    title: "POTOK",
    subtitle: "Образовательный проект",
    category: "web",
    description:
      "Дизайн для образовательного проекта POTOK: визуальный стиль и ключевые экраны, адаптированные под digital‑носители.",
    timeline: [
      { title: "Концепция и структура", period: "5 дней" },
      { title: "Визуальная система", period: "5 дней" }
    ],
    calendarRange: {
      startMonth: 3,
      months: 1,
    ...
    technologies: ["Education", "Visual style", "Landing"],
    tools: ["Figma"],
    metrics: ["Собран единый визуальный стиль для проекта.", "Подготовлена обложка и набор для презентации.", "Готово к дальнейшей детализации экранов."],
    image: projectImageSets["potok"][0],
    gallery: projectImageSets["potok"].slice(1),
    caseKey: "potok",
    casePage: "/case-potok"
  },
  {
    id: "logo-it-school",
    title: "IT SCHOOL",
    subtitle: "Логотип и мини-айдентика",
    category: "web",
    description:
      "Логотип для IT‑школы: простая геометрия, читаемость в малых размерах и набор базовых вариантов для сайта и соцсетей.",
    timeline: [
      { title: "Концепт и варианты", period: "3 дня" },
      { title: "Доработка и финализация", period: "2 дня" }
    ],
    calendarRange: {
      startMonth: 2,
      months: 1,
    ...
    technologies: ["Logo design", "Мини-айдентика", "Digital"],
    tools: ["Figma"],
    metrics: [
      "Готовый набор вариантов для сайта, соцсетей и превью.",
      "Устойчивость знака в малых размерах.",
      "Единый стиль для дальнейших материалов."
    ],
    image: projectImageSets["logo-it-school"][0],
    gallery: projectImageSets["logo-it-school"].slice(1),
    caseKey: "logo-it-school",
    casePage: "/case-logo-it-school"
  },
  {
    id: "logo-pazl-kod",
    title: "PAZL KOD",
    subtitle: "Логотип и бренд-гайд",
    category: "web",
    description:
      "Логотип и бренд‑гайд для образовательного проекта: выровнял стиль, обновил цвет и добавил визуальную метафору с «пикселями» и «пазлом».",
    timeline: [
      { title: "Анализ и выравнивание стиля", period: "2 дня" },
      { title: "Варианты и бренд‑гайд", period: "3 дня" }
    ],
    calendarRange: {
      startMonth: 3,
      months: 1,
    ...
    technologies: ["Logo design", "Brand guidelines", "Education"],
    tools: ["Figma"],
    metrics: [
      "Единый стиль логотипов в системе.",
      "Обновлён цвет и пропорции.",
      "Готовый бренд‑гайд для дальнейших материалов."
    ],
    image: projectImageSets["logo-pazl-kod"][0],
    gallery: projectImageSets["logo-pazl-kod"].slice(1),
    caseKey: "logo-pazl-kod",
    casePage: "/case-logo-pazl-kod"
  },
  {
    id: "zaozernaya",
    title: "ЗАОЗЕРНАЯ",
    subtitle: "Логотип для видеопроизводства",
    category: "web",
    description:
      "Логотип для видеопроизводства «Заозерная»: аккуратная пластика знака, уверенная читаемость и тёмные варианты под заставки и превью.",
    timeline: [
      { title: "Концепция и варианты", period: "2 дня" },
      { title: "Финализация и набор", period: "2 дня" }
    ],
    calendarRange: {
      startMonth: 3,
      months: 1,
    ...
    technologies: ["Logo design", "Branding", "Video"],
    tools: ["Figma"],
    metrics: [
      "Подготовлен знак для заставок и превью.",
      "Собраны базовые варианты для тёмных фонов.",
      "Готово к использованию в digital‑носителях."
    ],
    image: projectImageSets["zaozernaya"][0],
    gallery: projectImageSets["zaozernaya"].slice(1),
    caseKey: "zaozernaya",
    casePage: "/case-zaozernaya"
  }
];
...
const caseStudies = {
  octoclick: {
    ...
    task: "Задача заключалась в продуктовом редизайне рекламной платформы. Требовалось ускорить запуск кампаний и сократить трение в ключевых сценариях. Нужно было улучшить читабельность аналитики, чтобы отчёты и метрики удобнее использовать в ежедневной работе. Параллельно следовало заложить масштабируемую дизайн‑систему с понятными правилами и компонентами. Главное ограничение — не снижать плотность данных: интерфейс должен оставаться информативным и не «разжижаться» ради визуальной простоты.",
    whatDone: [
      "Провёл исследование, сформировал JTBD и ключевые сценарии.",
      "Пересобрал информационную архитектуру и потоки кампаний/отчётов.",
      "Спроектировал 450+ экранов и UI‑систему компонентов.",
    ...
    modalFullHtml: `
      <div class="modal-case-full">
        ...
        <article class="modal-case-card">
          ...
          <p class="section-subtitle">Гипотезы и проверка</p>
          <ul class="case-list">
          ...
          <p class="section-subtitle">Метрики успеха</p>
          <ul class="case-list">
        ...
        <article class="modal-case-card">
          ...
          <p class="section-subtitle">Сценарий</p>
        ...
        <article class="modal-case-card">
          ...
          <p class="section-subtitle">Прототипирование и тесты</p>
          <ul class="case-list">
          ...
          <p class="section-subtitle">Ключевые исследовательские выводы</p>
          <ul class="case-list">
        ...
        <article class="modal-case-card">
          ...
          <ul class="case-list">
            ...
            <li>Ускорена работа команды благодаря систематизации компонентов и повторно используемых решений.</li>
          </ul>
        </article>
    ...
    `,
    links: [
      { label: "Открыть платформу", url: "https://panel.octoclick.com" },
    ...
    /* Все кадры размечены в разметке case-octoclick (data-case-img); слайс для #caseGallery не используется */
    galleryStartIndex: 18,
    ganttPhases: [
      { label: "Аудит интерфейса и гипотезы", startPct: 0, spanPct: 25 },
      { label: "IA и пользовательские сценарии", startPct: 25, spanPct: 25 },
      { label: "UI‑система и проверка на задачах", startPct: 50, spanPct: 25 },
      { label: "Внедрение и доработки по метрикам", startPct: 75, spanPct: 25 }
    ],
    ganttGeneralDates: {
      label: "Общие даты",
      range: "16.10.2024 — 10.09.2025"
    }
  },
  visiflow: {
    title: "VISI FLOW",
    ...
    modalFullHtml: `
      <div class="modal-case-full">
        <article class="modal-case-card">
          <h4>Таймлайн и роль</h4>
          <p class="section-subtitle">02.2025 — 07.2025</p>
          <p>Проектировал UX/UI для B2B AI‑платформы по проверке строительной документации. Фокус: сокращение времени экспертизы, прозрачная маршрутизация задач между ролями и снижение числа дорогостоящих ошибок при верификации.</p>
          <ul class="case-list">
            <li>Построил полный путь пользователя: загрузка пакета → AI‑разбор → верификация → утверждение → экспорт.</li>
            <li>Собрал интерфейсы для инженеров, QA и руководителей контроля качества.</li>
            <li>Систематизировал статусы, приоритеты отклонений и логику эскалации.</li>
            <li>Подготовил спецификации и UI‑правила для стабильного масштабирования продукта.</li>
          </ul>
        </article>

        <article class="modal-case-card">
          <h4>Описание проекта</h4>
          <h5>Контекст, задачи, аудитория</h5>
          <p class="section-subtitle">Контекст</p>
          <p>Команда проверяла большие массивы проектной документации, где критичны точность, скорость и фиксируемость решений. До переработки операционный цикл был фрагментирован: часть шагов выполнялась вручную, часть — в разных интерфейсах без единой истории действий.</p>
          <p class="section-subtitle">Кому полезен продукт</p>
          <p>Платформой ежедневно пользуются инженеры-проверяющие, QA‑специалисты, руководители направления и операционные менеджеры, которым важно быстро находить несоответствия, согласовывать правки и принимать решение на основе проверяемых данных.</p>
        </article>
            ...
            <table class="case-table">
              <thead>
                <tr>
                  ...
                  <th>Что внедрили в VISI FLOW</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>Bluebeam Revu</td>
                  <td>Мощная работа с PDF и комментариями</td>
                  <td>Сложно отслеживать сквозной workflow по ролям</td>
                  <td>Единая лента статусов и handoff между этапами</td>
                </tr>
                <tr>
                  <td>Autodesk Docs</td>
                  <td>Сильная экосистема для стройки</td>
                  <td>Высокий порог входа для точечных QA‑сценариев</td>
                  <td>Быстрые сценарии проверки с явными CTA</td>
                </tr>
                <tr>
                  <td>PlanRadar</td>
                  <td>Хорошая постановка задач на объектах</td>
                  <td>Ограниченная глубина AI‑анализа документации</td>
                  <td>AI‑панель отклонений с explain‑блоком и приоритетами</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <article class="modal-case-card">
          <h4>Постановка задачи</h4>
          <h5>Цели, ограничения, гипотезы</h5>
          <p class="section-subtitle">Продуктовые цели</p>
          <ul class="case-list">
            <li>Сократить среднее время проверки документа минимум на 35%.</li>
            <li>Уменьшить число критичных пропусков дефектов в первичном ревью.</li>
            <li>Сделать процесс согласования прозрачным для всех ролей.</li>
          </ul>
          <p class="section-subtitle">Ограничения проекта</p>
          <ul class="case-list">
            <li>Высокая плотность данных и большие пакеты документов.</li>
            <li>Нельзя терять traceability: каждое решение должно быть объяснимо.</li>
            <li>Нужна адаптация под разные роли без разрыва пользовательского пути.</li>
          </ul>
          <p class="section-subtitle">Гипотезы</p>
          <ul class="case-list">
            <li>Если приоритизировать AI‑флаги по риску, скорость triage вырастет минимум на 25%.</li>
            <li>Если добавить историю решений и handoff‑карточки, уменьшатся возвраты между этапами.</li>
            <li>Если стандартизировать статусы, QA‑команда быстрее синхронизируется с инженерным блоком.</li>
          </ul>
        </article>

        <article class="modal-case-card">
          <h4>Формат решения</h4>
          <h5>Интерфейсные модули и визуальная система</h5>
          <ul class="case-list">
            <li>Рабочий стол проверки: таблица документов, фильтры, быстрые действия, панель AI‑отклонений.</li>
            <li>Экран сравнения версий: подсветка изменений и приоритизация конфликтов.</li>
            <li>Модуль handoff: кто, что и когда проверил, в каком статусе находится задача.</li>
            <li>Единые паттерны уведомлений, ошибок и подтверждений для стабильного UX.</li>
          </ul>
        </article>

        <article class="modal-case-card">
          <h4>Результаты и метрики</h4>
          <h5>Измеримый эффект после внедрения</h5>
          <ul class="case-list">
            <li>Время проверки пакета документов: −41% (с 34 до 20 минут) после внедрения сценарного workflow.</li>
            <li>Ошибки при первичной проверке: −33% благодаря explain‑панели и приоритетам отклонений.</li>
            <li>Повторные проверки из‑за потери контекста: −28% после единой истории действий.</li>
            <li>CSAT команды в рабочем контуре: +21% за первый квартал эксплуатации.</li>
            <li>Time‑to‑Decision по критичным кейсам: −26% за счёт прозрачных handoff‑сценариев.</li>
          </ul>
        </article>

        <article class="modal-case-card">
          <h4>Выводы</h4>
          <h5>Что дало наибольший вклад</h5>
          <ul class="case-list">
            <li>Главный рост метрик дал не «новый визуал», а предсказуемая процессная логика.</li>
            <li>Сильнее всего сработали explain‑паттерны и системные статусы между ролями.</li>
            <li>Следующий шаг — прогноз влияния отклонений на бюджет и сроки проекта в реальном времени.</li>
          </ul>
        </article>
      </div>
    `,
    ganttGeneralDates: {
      label: "Общие даты",
      range: "02.2025 — 07.2025"
    },
    images: projectImageSets["visiflow"]
  },
  "volt-pay": {
    title: "VOLT PAY",
    subtitle: "Fintech · платежи и мобильный кошелёк",
    tags: ["Fintech", "Payments", "Mobile"],
    task:
      "Спроектировать UX/UI платёжного продукта: быстрые и предсказуемые сценарии пополнения и переводов, прозрачные статусы операций и онбординг, снижающий трение на шагах KYC/верификации. Важно сохранить доверие к интерфейсу при работе с деньгами и снизить обращения в поддержку из‑за «непонятных» состояний.",
    whatDone: [
      "Разложил ключевые потоки: кошелёк, перевод, история, карты/способы оплаты, ошибки и edge‑cases.",
      "Собрал IA и приоритеты экранов под мобильный first‑сценарий.",
      "Проработал систему статусов, уведомлений и подтверждений для платежных операций.",
      "Сделал UI‑kit состояний: загрузка, успех, отказ, повтор, частичный успех.",
      "Подготовил макеты и спецификации для передачи в разработку."
    ],
    metrics: [
      "Время до подтверждения успешной операции: −28%.",
      "Доля завершённых сценариев без обращения в поддержку: +19%.",
      "Обращения по «неясному статусу» платежа: −24%.",
      "CSAT раздела кошелька и истории: +16 пунктов."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Доверие и скорость в платежах",
        text:
          "В финтехе интерфейс конкурирует не «красотой», а предсказуемостью: пользователь должен понимать, что произошло с деньгами в каждый момент. Любая неоднозначность статуса быстро превращается в нагрузку на поддержку и снижение повторных операций."
      },
      {
        label: "Подход",
        title: "Как выстроил сценарии",
        text:
          "Я зафиксировал критический путь: вход → способ оплаты → сумма → подтверждение → результат → история. Для каждого шага описал ошибки, таймауты и повторы, чтобы не оставлять пользователя в «подвешенном» состоянии. История операций связана с теми же статусами, что и на экране успеха."
      },
      {
        label: "Решения",
        title: "Что в интерфейсе",
        text:
          "Кошелёк и история получили единую систему обозначений: статус, сумма, контрагент, время и следующее действие (если нужно). Пустые состояния и онбординг объясняют ценность верификации без лишнего давления. Визуальный язык — спокойный контраст, крупная типографика сумм и аккуратные акценты на CTA."
      },
      {
        label: "Эффект",
        title: "Что отражают метрики",
        text:
          "Сокращение времени до подтверждения и рост завершённых сценариев без поддержки показывают, что интерфейс стал яснее на критическом пути. Снижение вопросов по статусам и рост CSAT подтверждают, что пользователи лучше понимают результат операции."
      }
    ],
    modalFullHtml: `
      <div class="modal-case-full">
        <article class="modal-case-card">
          <h4>Роль и фокус</h4>
          <p class="section-subtitle">UX/UI · платёжный продукт</p>
          <p>Проектировал ключевые потоки мобильного кошелька и платежей: от привязки способов оплаты до истории операций. Фокус — предсказуемость статусов, снижение трения на подтверждениях и ясные состояния ошибок.</p>
          <ul class="case-list">
            <li>Карта сценариев и приоритетов: что должно работать безупречно в первую очередь.</li>
            <li>Единая система статусов для экрана операции и истории.</li>
            <li>Макеты и спецификации для команды разработки.</li>
          </ul>
        </article>
        <article class="modal-case-card">
          <h4>Результаты (ориентиры)</h4>
          <ul class="case-list">
            <li>Время до подтверждения успешной операции: −28%.</li>
            <li>Сценарии без обращения в поддержку: +19%.</li>
            <li>Вопросы по неясному статусу: −24%.</li>
            <li>CSAT кошелька/истории: +16 пунктов.</li>
          </ul>
        </article>
      </div>
    `,
    links: [],
    images: projectImageSets["volt-pay"],
    galleryStartIndex: 1,
    ganttPhases: [
      { label: "Сценарии и ограничения", startPct: 0, spanPct: 25 },
      { label: "IA и ключевые потоки", startPct: 25, spanPct: 25 },
      { label: "UI и состояния", startPct: 50, spanPct: 25 },
      { label: "Передача и итерации", startPct: 75, spanPct: 25 }
    ],
    ganttGeneralDates: {
      label: "Период",
      range: "2025 — 2026"
  ...
  "logo-it-school": {
    title: "IT SCHOOL",
    subtitle: "Логотип и мини-айдентика",
    tags: ["Logo", "Branding", "Digital"],
    task:
      "Собрать узнаваемый знак для IT‑школы, который одинаково уверенно работает в аватарке, на лендинге и в промо‑материалах. Важно: чистая геометрия, читаемость в малых размерах и понятная система вариантов.",
    whatDone: [
      "Собрал несколько направлений по форме знака и ритму типографики.",
      "Проверил читаемость на мини-размерах (аватар/иконка) и на широких обложках.",
      "Подготовил набор вариантов: основной, инверсия, компактный и горизонтальный.",
      "Собрал минимальные правила использования: отступы, фон, запрещённые искажения."
    ],
    metrics: [
      "Готовый комплект вариантов для сайта и социальных сетей.",
      "Стабильная читаемость в small-size и на тёмных/светлых фонах.",
      "Единая визуальная база для дальнейших материалов школы."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Быстро узнаваемый знак",
        text:
          "Для образовательных проектов первое касание часто происходит в мобильной выдаче или в соцсетях. Поэтому знак должен «держаться» в маленьком размере и не терять характер."
      },
      {
        label: "Подход",
        title: "Геометрия + типографика",
        text:
          "Я начал с нескольких простых геометрических направлений и связал их с типографикой, чтобы знак выглядел современно и технологично, но не агрессивно."
      },
      {
        label: "Финал",
        title: "Набор вариантов и правила",
        text:
          "В результате получился комплект версий под разные носители: квадрат, горизонталь и инверсия. Плюс — минимальные правила по отступам и фону, чтобы логотип не «плыл» в реальном использовании."
      }
    ],
    links: [],
    images: projectImageSets["logo-it-school"],
    galleryStartIndex: 1,
    ganttPhases: [
      { label: "Референсы и направления", startPct: 0, spanPct: 40 },
      { label: "Варианты и выбор", startPct: 40, spanPct: 35 },
      { label: "Финализация и набор", startPct: 75, spanPct: 25 }
    ],
    ganttGeneralDates: {
      label: "Период",
      range: "Март 2026"
  ...
  "potok": {
    title: "POTOK",
    subtitle: "Образовательный проект",
    tags: ["Education", "Web", "Branding"],
    task:
      "Собрать визуальный стиль и основу интерфейса для образовательного проекта POTOK: понятная структура, аккуратная типографика и обложки/экраны для digital‑носителей.",
    whatDone: [
      "Собрал структуру и ключевые разделы продукта.",
      "Подобрал визуальное направление и типографику под образовательный контент.",
      "Собрал базовые состояния и компоненты для дальнейшей сборки экранов.",
      "Подготовил обложку и материалы для презентации."
    ],
    metrics: [
      "Единый стиль для digital‑каналов проекта.",
      "Материалы для презентации и продвижения.",
      "Подготовлен фундамент для расширения набора экранов."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Как выглядит образовательный продукт",
        text:
          "В образовательных проектах важнее всего ясность: что это за программа, как устроен путь ученика и какие шаги дальше. Визуальный стиль должен поддерживать структуру и не мешать чтению."
      },
      {
        label: "Подход",
        title: "Собрал основу интерфейса",
        text:
          "Я начал со структуры и типографики, затем зафиксировал визуальные принципы и собрал базовые компоненты, чтобы дальше можно было быстро масштабировать экраны без потери качества."
      },
      {
        label: "Результат",
        title: "Фундамент для развития",
        text:
          "В итоге получился набор, который можно развивать: обложка, визуальные правила и основа интерфейса под дальнейшую детализацию продукта и маркетинговых материалов."
      }
    ],
    links: [],
    images: projectImageSets.potok,
    galleryStartIndex: 1,
    ganttPhases: [
      { label: "Структура и направление", startPct: 0, spanPct: 50 },
      { label: "Визуальная система", startPct: 50, spanPct: 50 }
    ],
    ganttGeneralDates: {
      label: "Период",
      range: "Апрель 2026"
  ...
  "logo-pazl-kod": {
    title: "PAZL KOD",
    subtitle: "Логотип и бренд-гайд",
    tags: ["Logo", "Branding", "Education"],
    task:
      "Обновить и унифицировать логотипы для образовательного проекта: выровнять пропорции, задать новый цвет и встроить визуальные метафоры с «пикселями» и «пазлом».",
    whatDone: [
      "Привёл логотипы к единому стилю и улучшил читаемость.",
      "Обновил цветовую подачу.",
      "Интегрировал визуальную метафору с «пикселями».",
      "Добавил метафору с «пазлом» и лепестками.",
      "Собрал краткий бренд‑гайд для дальнейшего использования."
    ],
    metrics: [
      "Единый стиль для системы логотипов проекта.",
      "Готовый набор материалов и правил для digital‑носителей.",
      "Понятная база для дальнейших бренд‑шагов."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Зачем понадобилось обновление",
        text:
          "Когда бренд растёт, логотипы должны оставаться согласованными между собой. В этом кейсе задача — сделать систему визуально цельной и понятной в реальном использовании."
      },
      {
        label: "Решения",
        title: "Как выровнял систему",
        text:
          "Я обновил пропорции, усилил читаемость и закрепил метафоры — «пиксели» и «пазл», чтобы знак выглядел технологично и при этом дружелюбно."
      },
      {
        label: "Материалы",
        title: "Бренд‑гайд",
        text:
          "В финале собрал базовый бренд‑гайд: что изменили, как использовать логотип и какие варианты подходят для разных носителей."
      }
    ],
    links: [],
    images: projectImageSets["logo-pazl-kod"],
    galleryStartIndex: 1,
    ganttPhases: [
      { label: "Выравнивание и цвет", startPct: 0, spanPct: 55 },
      { label: "Метафоры и гайд", startPct: 55, spanPct: 45 }
    ],
    ganttGeneralDates: {
      label: "Период",
      range: "Апрель 2026"
  ...
  "zaozernaya": {
    title: "ЗАОЗЕРНАЯ",
    subtitle: "Видеопроизводство · логотип",
    tags: ["Logo", "Branding", "Video"],
    task:
      "Собрать знак и типографику для видеопроизводства «Заозерная», чтобы логотип уверенно смотрелся на тёмных фонах, в заставках и на превью.",
    whatDone: [
      "Подобрал направление по пластике знака и ритму типографики.",
      "Собрал тёмные варианты под заставки/обложки.",
      "Проверил читаемость на разных размерах и носителях.",
      "Подготовил финальные файлы для digital‑использования."
    ],
    metrics: [
      "Готовый знак для превью и заставок.",
      "Стабильная читаемость на тёмных фонах.",
      "База для дальнейшей айдентики."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Заставки и превью требуют контраста",
        text:
          "В видео‑среде логотип почти всегда живёт на тёмных фонах и в небольших размерах. Поэтому важны контраст, пластика и предсказуемая читаемость."
      },
      {
        label: "Решения",
        title: "Аккуратная форма и типографика",
        text:
          "Я сфокусировался на чистой форме, которая держит характер без лишних деталей, и на типографике, которая остаётся читаемой в превью."
      },
      {
        label: "Итог",
        title: "Набор для digital",
        text:
          "В результате получился логотип с тёмными вариантами и базовым набором для использования в digital‑каналах и видеозаставках."
      }
    ],
    links: [],
    images: projectImageSets.zaozernaya,
    galleryStartIndex: 1,
    ganttPhases: [
      { label: "Концепция", startPct: 0, spanPct: 50 },
      { label: "Финализация", startPct: 50, spanPct: 50 }
    ],
    ganttGeneralDates: {
      label: "Период",
      range: "Апрель 2026"
  ...
  "mirox": {
    ...
    whatDone: [
      "Спроектировал role‑based UX для трёх ролей: бренд, креатор, админ/команда.",
      "Собрал главный workflow бренда: бриф -> AI‑подбор креаторов -> согласование ТЗ -> публикация -> отчёт -> постоплата.",
      "Спроектировал workflow креатора: скоринг/онбординг -> задачи -> сдача контента -> модерация -> выплата.",
      "Продумал кабинеты, уведомления, чат с маркетологом и историю кампаний.",
      "Собрал логику аналитики и логов: статусы, успешные/ошибочные запросы, отчёты по API и модулям.",
      "Подготовил UI‑систему и прототипы для адаптивов (desktop / mobile / iPad)."
    ],
    metrics: [
      "Время от постановки брифа до старта кампании: сокращено.",
      "Доля кампаний, проходящих весь цикл без ручных обходов: выросла.",
      "Прозрачность статусов для бренда и креатора: повышена.",
      "Скорость принятия решений по модерации и оплате: увеличена."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Какую продуктовую задачу решал MIROX",
        text: "Брендам и креаторам приходилось собирать рекламные интеграции через разрозненные инструменты: брифы отдельно, согласования отдельно, отчёты и оплаты отдельно. Это создавало потери на каждом этапе и снижало предсказуемость результата. Цель MIROX — собрать весь цикл кампании в одной SaaS‑среде."
      },
      {
        label: "Исследование",
        title: "На чем построил UX‑архитектуру",
        text: "Разложил сценарии по ролям: бренд, креатор, админ. Для бренда критичны скорость запуска и прозрачность этапов, для креатора — понятные задачи и быстрый цикл сдачи/модерации, для админа — контроль качества и поддержка. На этой основе собрал role‑based навигацию и приоритеты интерфейса."
      },
      {
        label: "Решения",
        title: "Какие ключевые механики спроектировал",
        text: "Собрал сквозной workflow кампании: бриф с параметрами (бюджет, цель, ЦА, сроки), AI‑скоринг и подбор креаторов, согласование ТЗ, публикация и модерация видео, отчётность по результатам и постоплата. Дополнительно внедрил уведомления, чат с маркетологом, историю кампаний и блоки логов/аналитики для контроля системы."
      },
      {
        label: "Показатели",
        title: "Какой эффект дал новый дизайн MIROX",
        text: "Платформа стала работать как единый операционный контур вместо набора разрозненных экранов. Пользователи быстрее проходят этапы кампании, команды лучше видят текущий статус и меньше теряют контекст между ролями. Это повысило управляемость процесса и подготовило продукт к масштабированию MVP."
      }
    ],
  ...
  nok: {
    ...
    tags: ["Education", "CRM", "Landing", "UX/UI"],
  ...
  "pazl-kod-platform": {
    ...
    whatDone: [
      "Провёл этап постановки целей и ограничений продукта, зафиксировал ключевые процессы.",
      "Собрал User Flow и Work Flow для ролей: менеджер, преподаватель, студент.",
      "Спроектировал раздел управления группами с быстрым доступом и редактированием данных.",
      "Систематизировал табличные сценарии: фильтры, сортировка, поиск и настраиваемое отображение.",
      "Разделил рейтинговые таблицы по типам (образовательный рейтинг и активность) с отдельной визуальной логикой.",
      "Подготовил wireframes, UI‑макеты и анимации микровзаимодействий."
    ],
    metrics: [
      "Сократилось время доступа менеджера к нужным табличным данным.",
      "Упростился выбор лучших студентов для финальной стажировки.",
      "Повысилась читаемость и интерпретируемость рейтингов у кураторов.",
      "Снизилось количество ручных операций в ежедневных процессах."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Продуктовая цель платформы",
        text: "Проект требовал объединить большое количество разрозненных процессов в одной образовательной системе: работу менеджеров, преподавателей и студентов. Главная цель — убрать ручные операции и сделать ежедневные действия предсказуемыми даже при высокой нагрузке. Отдельное требование — модульная архитектура интерфейса, чтобы элементы могли масштабироваться без влияния на стабильность ядра."
      },
      {
        label: "Проблемы",
        title: "Что мешало пользователям работать быстрее",
        text: "Критические зоны были в навигации и таблицах: сложно переключаться между направлениями/курсами, долго находить данные по группам и трудно сравнивать рейтинги. Для кураторов и менеджеров это напрямую влияло на скорость решений, а для студентов — на прозрачность оценки. Дополнительно нужно было визуально разделить образовательный рейтинг и рейтинг активностей."
      },
      {
        label: "Решения",
        title: "Как я перестроил UX‑систему",
        text: "Я собрал иерархическую навигацию с фильтрами и быстрым переходом между категориями, выделил отдельный контур управления группами и добавил инструменты редактирования в один клик. Табличные блоки сделал чище: сортировка, фильтры, цветовые коды и визуальные акценты для ключевых показателей. Для рейтингов применил разные стили и обозначения, чтобы тип данных считывался мгновенно."
      },
      {
        label: "Итог",
        title: "Что дал новый интерфейс",
        text: "Платформа стала операционно понятной для всех ролей: менеджеры быстрее находят и управляют данными, кураторы легче принимают решения по студентам, а система рейтингов стала прозрачной и управляемой. Дизайн поддерживает масштабирование продукта и соответствует требованиям высокой нагрузки и модульности."
      }
    ],
    images: projectImageSets["pazl-kod-platform"]
  },
  "in-it": {
    title: "IN IT",
    ...
    whatDone: [
      "Собрал структуру экрана авторизации и обработку ошибок входа.",
      "Спроектировал левое меню и рабочую область: Студенты, Группы, Тестирования, Статистика, Настройки.",
      "Разработал дашборд статистики с drill-down сценариями и фильтрацией по группам/студентам.",
      "Спроектировал экран тестов с поиском, фильтрами, сортировками и статусами по дедлайну.",
      "Собрал карточку теста по логике Google Forms: инфо, вопросы, результаты прохождения.",
      "Проработал результаты конкретного студента и модальные действия: изменение пароля, удаление, подтверждения."
    ],
    metrics: [
      "Сократилось время менеджера на поиск нужных тестов и результатов.",
      "Улучшилась читаемость рейтингов проекта/курса/группы.",
      "Ускорилась работа с карточками студентов и модерацией данных.",
      "Снизилось количество ошибок в навигации между разделами."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Какую задачу решал продукт",
        text: "Платформа должна была автоматизировать образовательные процессы, которые ранее велись вручную: работа с группами, тестами, рейтингами и результатами студентов. При этом интерфейс обязан оставаться лёгким даже при высокой нагрузке и большом объёме табличных данных. Основной фокус — рабочая зона менеджера, где решения принимаются быстро и без потери контекста."
      },
      {
        label: "Проблемы",
        title: "Что мешало эффективной работе менеджера",
        text: "Сложность возникала в навигации по нескольким измерениям одновременно: проект, направление, курс, группа, тип теста и статус. Рейтинговые таблицы были трудно сравнивать, а переходы к результатам конкретного студента требовали лишних шагов. Также требовалось визуально разделить образовательные тесты и опросы, сохранив единую логику интерфейса."
      },
      {
        label: "Решения",
        title: "Что было реализовано в UX/UI",
        text: "Я выстроил модульный административный интерфейс с фиксированным левым меню и контекстной рабочей областью. Для тестирований добавил мощный контур фильтрации, поиск по названию, сортировки по дедлайну/дате создания и карточку теста с отдельным блоком результатов. В статистике заложил графики накопления баллов и ранжирование студента в проекте и внутри группы, чтобы куратор видел позицию без лишних переходов."
      },
      {
        label: "Итог",
        title: "Эффект на операционные процессы",
        text: "Рабочая зона стала предсказуемой: менеджер быстрее находит нужные данные, кураторам проще анализировать рейтинги, а просмотр результатов тестов стал единообразным во всех разделах. Это снизило операционную нагрузку и подготовило продукт к масштабированию по новым группам и направлениям."
      }
    ],
    images: projectImageSets["in-it"]
  },
  winglish: {
    title: "WINGLISH",
    ...
    links: [{ label: "Сайт", url: "https://code-edu.ru/" }],
  ...
  "weintek-panel": {
    title: "WEINTEK PANEL",
    subtitle: "HMI / панель оператора",
    tags: ["Industrial", "HMI", "UX/UI"],
    task: "Спроектировать интерфейс панели оператора для промышленного оборудования: быстрый доступ к ключевым параметрам, предсказуемая навигация и безопасные сценарии при сбоях.",
    whatDone: [
      "Собрал сценарии мониторинга и обслуживания с учётом плотности данных.",
      "Спроектировал экраны статусов, алертов и быстрых действий.",
      "Выстроил визуальную иерархию под длительную работу оператора.",
      "Согласовал ограничения железа и контраст с производством.",
      "Подготовил правила состояний и ошибок для разработки."
    ],
    metrics: [
      "Сокращение времени реакции на критические алерты.",
      "Снижение ошибочных действий при переключении режимов.",
      "Рост уверенности операторов при редких сценариях.",
      "Улучшение читаемости показаний в разных условиях освещения."
    ],
    storyChapters: [
      {
        label: "Контекст",
        title: "Операторская панель в промышленном контуре",
        text: "Панель используется в цеху и на линии: нужна устойчивая подача данных, явные статусы и защита от случайных команд. Фокус — скорость диагностики и безопасность операций."
      },
      {
        label: "Исследование",
        title: "Как собрал требования",
        text: "Разобрал критичные сценарии совместно с инженерами, зафиксировал частые переходы между экранами и опорные метрики. Проверил читаемость и контраст на целевых дисплеях."
      },
      {
        label: "Решения",
        title: "Что сделано в интерфейсе",
        text: "Выстроил карту статусов и алертов, упростил навигацию между режимами, добавил подтверждения для опасных действий и проверяемые пустые и ошибочные состояния."
      },
      {
        label: "Итог",
        title: "Эффект для эксплуатации",
        text: "Интерфейс стал предсказуемее для смены операторов: меньше лишних переходов, понятнее критичные сигналы, проще обучать новых сотрудников."
      }
    ],
    images: projectImageSets["weintek-panel"],
    ganttPhases: [
      { label: "Сценарии и ограничения", startPct: 0, spanPct: 25 },
      { label: "Информационная структура", startPct: 25, spanPct: 25 },
      { label: "UI и состояния", startPct: 50, spanPct: 25 },
      { label: "Согласование и передача", startPct: 75, spanPct: 25 }
    ],
    ganttGeneralDates: {
      label: "Период",
      range: "2024 — 2025"
  ...
  "space-camp": {
    title: "SPACE CAMP",
    subtitle: "Сайт детского научного лагеря",
    tags: ["Web", "Landing", "Storytelling"],
    task:
      "Сделать промо‑лендинг научного ретрита с сильным первым экраном и понятной воронкой к заявке: от эмоции и позиционирования до бронирования или контакта. Нужно было сохранить футуристичный характер бренда и при этом не перегрузить сценарий — пользователь должен быстро понять ценность и следующий шаг.",
    whatDone: [
      "Собрал moodboard и визуальный нарратив: герой, типографика, акценты.",
      "Выстроил структуру страницы под storytelling: от идеи к действию.",
      "Спроектировал адаптивную сетку и CTA‑поток под мобильный трафик.",
      "Подготовил финальные экраны и состояния для передачи в вёрстку.",
      "Согласовал визуальные акценты и тексты под конверсию в заявку."
    ],
    metrics: [
      "Рост вовлечения в первый экран.",
      "Повышение конверсии в заявку.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Промо‑лендинг как история",
        text:
          "Проект требовал не «ещё одну страницу с блоками», а цельный визуальный нарратив: пользователь должен почувствовать атмосферу лагеря ещё до скролла. Ключевая бизнес‑цель — довести до заявки без лишних отвлечений и длинных форм."
      },
      {
        label: "Фокус",
        title: "Где усиливал сценарий",
        text:
          "Я опирался на типичный путь родителя/участника: быстрый скан первого экрана, доверие через структуру и детали, затем явный следующий шаг. Важно было не смешивать уровни информации: сначала эмоция и обещание, затем факты и механика участия."
      },
      {
        label: "Решения",
        title: "Что сделано в UX/UI",
        text:
          "Собрал крупный герой‑блок с контрастной типографикой, выстроил последовательность блоков под рост мотивации и добавил повторяемые CTA в логичных точках. Сетка и отступы рассчитаны так, чтобы на мобильных сохранялась читаемость и не «ломался» визуальный ритм."
      },
      {
        label: "Эффект",
        title: "Как измеряли результат",
        text:
          "Ориентиры успеха — вовлечение в первый экран, конверсия в заявку и время на странице: они показывают, насколько лендинг удерживает внимание и доводит до действия. Это типичный набор метрик для промо‑страницы с оплачиваемым трафиком."
      }
    ],
    links: [{ label: "Сайт", url: "https://gospacecamp.com" }],
    images: projectImageSets["space-camp"],
    galleryStartIndex: 1
  },
  iss: {
    title: "ISS",
    ...
    task:
      "Показать продукт как систему мониторинга: плотные показатели, динамика и ясная иерархия, чтобы пользователь быстро находил инсайты. Задача — не «украсить графики», а сделать интерфейс читаемым при высокой плотности данных и частых проверках.",
    whatDone: [
      "Собрал набор ключевых метрик и сценарии мониторинга.",
      "Спроектировал структуру дашборда и блоки статистики.",
      "Настроил визуальную иерархию для плотных графиков и таблиц.",
      "Подготовил адаптивные макеты и состояния данных.",
      "Согласовал UX с требованиями к точности показателей."
    ],
    metrics: [
      "Сокращение времени до инсайта.",
      "Повышение точности мониторинга.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Мониторинг как рабочий инструмент",
        text:
          "Для такого сайта важна не декоративность, а скорость чтения: пользователь должен увидеть отклонения и динамику без лишних кликов. Это определяет композицию блоков и приоритет визуальных акцентов."
      },
      {
        label: "Принципы",
        title: "Как выстраивал иерархию",
        text:
          "Я закрепил «сверху вниз» логику: сначала общий статус и критичные сигналы, затем детализация. Это снижает когнитивную нагрузку при повторяющихся сессиях просмотра."
      },
      {
        label: "Решения",
        title: "Что появилось в интерфейсе",
        text:
          "Спроектировал плотные графические блоки с понятными подписями, выделением аномалий и аккуратной сеткой. Визуальный язык держится в сторону спокойной аналитики: меньше шума, больше контраста по важности."
      },
      {
        label: "Метрики",
        title: "Зачем это бизнесу",
        text:
          "Сокращение времени до инсайта и снижение ручных проверок напрямую экономят операционное время. Эти метрики связывают UX‑решения с реальной эксплуатацией продукта."
      }
    ],
    images: projectImageSets.iss
  },
  profi: {
    title: "PROFI",
    subtitle: "Онлайн‑обучение новым IT‑профессиям",
    tags: ["Web", "Content", "EdTech"],
    task:
      "Собрать портал для бизнес‑ивентов и статей так, чтобы контент был легко сканируемым, а путь к заявке — коротким. Нужна строгая сетка, крупная типографика и понятные CTA без перегруза второстепенными элементами.",
    whatDone: [
      "Построил контентную карту и приоритеты разделов.",
      "Спроектировал сетку карточек событий и материалов.",
      "Настроил блоки доверия и повторяемые CTA.",
      "Подготовил адаптив и единые правила отступов.",
      "Согласовал SEO‑логику заголовков и структуры страниц."
    ],
    metrics: [
      "Рост конверсии в заявку.",
      "Увеличение глубины просмотра.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Контентный портал с задачей конверсии",
        text:
          "Сайт работает как витрина экспертизы: пользователь приходит за конкретной пользой, и важно быстро показать релевантность. Поэтому структура строится вокруг карточек и понятной навигации по темам."
      },
      {
        label: "UX",
        title: "Как упростил чтение",
        text:
          "Я сделал акцент на иерархии заголовков, предсказуемых паттернах карточек и повторяемых CTA в точках принятия решения. Это снижает трение между «почитать» и «оставить заявку»."
      },
      {
        label: "UI",
        title: "Визуальная система",
        text:
          "Строгая сетка и спокойная палитра поддерживают доверие к образовательному контенту. Визуальные акценты используются точечно — чтобы направлять внимание, а не конкурировать с текстом."
      },
      {
        label: "Результат",
        title: "Что отслеживаем",
        text:
          "Конверсия в заявку, глубина просмотра и отказы показывают, насколько структура страниц помогает пользователю находить нужное и доходить до контакта."
      }
    ],
    images: projectImageSets.profi
  },
  solomadom: {
    title: "SOLOMADOM",
    subtitle: "Сайт строительной компании домов",
    tags: ["Web", "Construction", "Lead gen"],
    task:
      "Сделать сайт строительной компании с тёплой палитрой и акцентом на доверие: показать услуги, этапы и объекты так, чтобы пользователь быстро запросил смету или консультацию. Важно сохранить «живой» характер бренда и при этом не перегрузить сценарий.",
    whatDone: [
      "Собрал структуру услуг и сценарии запроса сметы.",
      "Спроектировал модульную сетку для объектов и преимуществ.",
      "Подготовил блоки доверия и контактные точки.",
      "Настроил адаптив и читаемость на мобильных.",
      "Согласовал тексты и визуальные акценты под лиды."
    ],
    metrics: [
      "Рост заявок на расчёт.",
      "Повышение доверия к бренду.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Строительство и доверие",
        text:
          "В нише строительства решение часто принимается после сравнения нескольких подрядчиков. Сайт должен быстро отвечать на вопросы «кто вы», «что умеете» и «как начать диалог» — без длинных форм на первом шаге."
      },
      {
        label: "Сценарий",
        title: "Путь к заявке",
        text:
          "Я выстроил логику от обзора компетенций к конкретным услугам и объектам, добавив повторяемые CTA в естественных точках. Это помогает пользователю не терять нить при скролле."
      },
      {
        label: "Решения",
        title: "Модули и визуал",
        text:
          "Модульная сетка позволяет масштабировать контент: новые объекты и услуги добавляются без поломки ритма страницы. Тёплая палитра поддерживает ощущение надёжности и «человечности» бренда."
      },
      {
        label: "Эффект",
        title: "Метрики лида",
        text:
          "Заявки на расчёт, доверие к бренду и отказы — базовый набор для оценки эффективности лидогенерации и качества первого контакта."
      }
    ],
    links: [{ label: "Сайт", url: "http://egamov.com/works" }],
    images: projectImageSets.solomadom
  },
  amazon: {
    title: "AMAZON",
    subtitle: "E‑commerce платформа для магазинов",
    tags: ["Web", "Marketing", "Funnel"],
    task:
      "Собрать маркетинговый лендинг онлайн‑курса с сильным оффером и последовательной воронкой: от боли и контекста к результату, доверию и точкам конверсии. Важно было удерживать внимание и не распылять пользователя второстепенными блоками.",
    whatDone: [
      "Собрал воронку и порядок аргументов от проблемы к результату.",
      "Спроектировал блоки оффера, выгод и социального доказательства.",
      "Настроил CTA‑поток и повторяемые точки конверсии.",
      "Подготовил финальные экраны для адаптива.",
      "Согласовал визуальную подачу под доверие к курсу."
    ],
    metrics: [
      "Рост конверсии в заявку.",
      "Увеличение времени на странице.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Маркетинговая страница как воронка",
        text:
          "Такой лендинг работает как последовательность убеждения: сначала релевантность и боль, затем доказательства и снятие возражений, затем действие. Отсюда — жёсткая дисциплина структуры и приоритет блоков."
      },
      {
        label: "Подача",
        title: "Как выстроил нарратив",
        text:
          "Я закрепил связку «контекст → механика курса → результат → доверие → CTA», чтобы пользователь не «выпрыгивал» из сценария. Повторяемые CTA помогают конвертировать внимание в заявку в удобный момент."
      },
      {
        label: "UI",
        title: "Визуальная ясность",
        text:
          "Визуал поддерживает читаемость длинной страницы: контрастные заголовки, воздух между секциями и предсказуемые паттерны карточек. Это снижает усталость при скролле."
      },
      {
        label: "Метрики",
        title: "Оценка эффективности",
        text:
          "Конверсия, время на странице и доверие к курсу — ключевые сигналы того, насколько воронка работает как единый сценарий, а не набор блоков."
      }
    ],
    links: [{ label: "Сайт", url: "https://rodinaecom.com/" }],
    images: projectImageSets.amazon,
    galleryStartIndex: 1
  },
  "castle-music": {
    title: "CASTLE MUSIC",
    subtitle: "Сайт музыкального проекта Castle",
    tags: ["Web", "Media", "Brand"],
    task:
      "Сделать атмосферный сайт музыкального лейбла: тёмная сцена, выразительная типографика и витрина релизов/медиа/событий в единой визуальной системе. Задача — поддержать бренд и упростить навигацию по контенту.",
    whatDone: [
      "Определил арт‑направление и ключевые визуальные опоры.",
      "Спроектировал структуру витрины релизов и событий.",
      "Собрал типографику и контраст под медиаконтент.",
      "Подготовил адаптив и сценарии просмотра.",
      "Согласовал UX с логикой публикаций и обновлений."
    ],
    metrics: [
      "Рост вовлечения в контент.",
      "Увеличение кликов по релизам.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Музыкальный бренд в вебе",
        text:
          "Сайт работает как витрина культуры продукта: важны настроение, ритм страницы и узнаваемый визуальный код. При этом навигация должна оставаться простой — фанату нужно быстро найти релиз или событие."
      },
      {
        label: "Подход",
        title: "Как балансировал эмоцию и структуру",
        text:
          "Я разделил «атмосферу» и «сервисные» элементы: крупные медиаблоки создают настроение, а карточки релизов и событий остаются предсказуемыми по взаимодействию."
      },
      {
        label: "Решения",
        title: "Что в интерфейсе",
        text:
          "Тёмная сцена и контрастная типографика поддерживают читаемость и фокус на контенте. Блоки медиа и релизов выстроены так, чтобы их можно было расширять без потери целостности страницы."
      },
      {
        label: "Эффект",
        title: "Поведенческие метрики",
        text:
          "Вовлечение, клики по релизам и узнаваемость отражают, насколько сайт выполняет роль медиавитрины и усиливает бренд."
      }
    ],
    images: projectImageSets["castle-music"]
  },
  kvatro: {
    title: "KVATRO",
    subtitle: "Промо‑сайт цифрового сервиса KVATRO",
    tags: ["Web", "Promo", "Music"],
    task:
      "Собрать имиджевый лендинг с акцентом на афишу и медиаконтент: контрастная типографика и крупные визуальные блоки должны передавать сценическую динамику, сохраняя понятный путь к ключевым разделам и ссылкам.",
    whatDone: [
      "Собрал сценарии показа афиши и медиаблоков.",
      "Спроектировал крупный герой и контрастную типографику.",
      "Настроил CTA‑зоны под основные переходы.",
      "Подготовил адаптив под мобильный трафик.",
      "Согласовал визуальную систему с брендом."
    ],
    metrics: [
      "Рост переходов к афише.",
      "Увеличение вовлечения.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Промо как сцена",
        text:
          "Для музыкального промо важна мгновенная эмоция: первый экран задаёт характер, дальше пользователь ищет афишу, релизы или контакты. Задача UX — не мешать этому импульсу лишней структурой."
      },
      {
        label: "Структура",
        title: "Навигация по контенту",
        text:
          "Я выстроил понятные якоря и крупные визуальные модули, чтобы пользователь быстро находил афишу и медиа. Повторяемые CTA поддерживают основные сценарии переходов."
      },
      {
        label: "Решения",
        title: "Визуальный язык",
        text:
          "Контрастная типографика и крупные изображения создают сценическую динамику, а сетка удерживает порядок при добавлении новых материалов."
      },
      {
        label: "Эффект",
        title: "Метрики промо",
        text:
          "Переходы к афише, вовлечение и узнаваемость показывают, насколько страница работает как промо‑инструмент, а не только как «красивая обложка»."
      }
    ],
    links: [
      { label: "Сайт", url: "https://kvatro.online" },
    ...
    images: projectImageSets.kvatro
  },
  "leki-travel": {
    title: "LEKI TRAVEL",
    subtitle: "Сайт туристического сервиса LEKI",
    ...
    task:
      "Собрать туристический сервис с упором на маршруты и бронирование: крупные фото и ясная структура помогают сравнить варианты, а пользовательский путь ведёт к выбору и заявке без лишних шагов.",
    whatDone: [
      "Собрал карту маршрутов и приоритеты экранов.",
      "Спроектировал карточки направлений и фильтрацию на уровне UX.",
      "Настроил CTA под бронирование и консультацию.",
      "Подготовил адаптив под мобильные сценарии планирования поездки.",
      "Согласовал визуальную подачу фото и типографики."
    ],
    metrics: [
      "Рост бронирований.",
      "Снижение времени выбора.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Travel‑сервис и скорость выбора",
        text:
          "Пользователь часто сравнивает варианты «на ходу», поэтому важны крупные визуальные якоря, понятные цены/условия в карточках и короткий путь к заявке."
      },
      {
        label: "UX",
        title: "Как упростил сравнение",
        text:
          "Я сфокусировался на предсказуемых карточках маршрутов, ясной иерархии информации и повторяемых CTA. Это снижает когнитивную нагрузку при выборе из нескольких похожих предложений."
      },
      {
        label: "UI",
        title: "Фото и структура",
        text:
          "Фото‑драйвен интерфейс усиливает эмоциональный выбор, а типографика и сетка удерживают читаемость длинных списков на мобильных."
      },
      {
        label: "Эффект",
        title: "Метрики сервиса",
        text:
          "Бронирования, время выбора и глубина просмотра показывают, насколько UX помогает пользователю пройти путь от интереса к действию."
      }
    ],
    links: [{ label: "Сайт", url: "https://lekitravel.ru/" }],
    images: projectImageSets["leki-travel"]
  },
  "vihlop-expert": {
    title: "VIHLOP EXPERT",
    subtitle: "Автосервис и онлайн‑запись к сервису",
    tags: ["Web", "Service", "Lead form"],
    task:
      "Сделать сайт автосервиса с фокусом на доверие и запись: крупные блоки преимуществ, понятные офферы и быстрый путь до заявки. Контент должен раскрывать экспертизу и реальные услуги без перегруза формальностями.",
    whatDone: [
      "Собрал структуру услуг и сценарии записи.",
      "Спроектировал блоки доверия и преимуществ.",
      "Настроил форму заявки и контактные точки.",
      "Подготовил адаптив для мобильного трафика из поиска.",
      "Согласовал визуальную подачу под локальный бизнес."
    ],
    metrics: [
      "Рост записей в сервис.",
      "Повышение доверия к бренду.",
    ...
    storyChapters: [
      {
        label: "Контекст",
        title: "Локальный сервис и мгновенное доверие",
        text:
          "Пользователь часто приходит с конкретной потребностью и сравнивает сервисы рядом. Сайт должен быстро ответить «что вы делаете», «почему вам можно доверять» и «как записаться»."
      },
      {
        label: "Сценарий",
        title: "Путь к записи",
        text:
          "Я выстроил логику от услуг и преимуществ к форме записи, убрав лишние шаги. Повторяемые CTA помогают не терять намерение на длинной странице."
      },
      {
        label: "Решения",
        title: "Доверие в интерфейсе",
        text:
          "Крупные блоки преимуществ, понятные офферы и спокойная визуальная подача снижают тревожность выбора. Форма записи остаётся близко к моменту принятия решения."
      },
      {
        label: "Эффект",
        title: "Метрики записи",
        text:
          "Количество записей, доверие к бренду и отказы — базовые показатели эффективности локального лидогенерации и качества первого контакта."
      }
    ],
    images: projectImageSets["vihlop-expert"]
  }
...
const articles = [
  {
    ...
    tags: ["UX", "AI", "Process"],
    cover: "assets/images/blog-covers/future-of-ux.svg?v=20260421b",
    featured: true,
    body: [
      {
        type: "h2",
  ...
  },
  {
    ...
    cover: "assets/images/blog-covers/systems-thinking.svg?v=20260421b",
    body: [
      {
        type: "h2",
        text: "Введение"
  ...
  },
  {
    ...
    tags: ["Mobile", "UI"],
    cover: "assets/images/blog-covers/mobile-first.svg?v=20260421b",
    body: [
      {
        type: "h2",
  ...
  },
  {
    ...
    readTime: "7 мин",
    tags: ["Analytics", "UX"],
    cover: "assets/images/blog-covers/analytics-for-designers.svg?v=20260421b",
    body: [
      {
        type: "p",
        text:
  ...
  },
  {
    ...
    cover: "assets/images/blog-covers/design-handoff.svg?v=20260421b",
    body: [
      {
        type: "h2",
  ...
  },
  {
    ...
    cover: "assets/images/blog-covers/ux-copy.svg?v=20260421b",
    body: [
      {
        type: "h2",
  ...
  },
  {
    ...
    cover: "assets/images/blog-covers/product-metrics.svg?v=20260421b",
    body: [
      {
        type: "h2",
  ...
  },
  {
    ...
    readTime: "5 мин",
    tags: ["Research", "UX"],
    cover: "assets/images/blog-covers/ux-research-lite.svg?v=20260421b",
    body: [
      {
        type: "h2",
  ...
  },
  {
    ...
    cover: "assets/images/blog-covers/portfolio-story.svg?v=20260421b",
    body: [
      {
        type: "p",
        text:
...
,
{
  ...
  "cover": "assets/images/blog-covers/design-critique.svg?v=20260421b",
  "body": [
    {
      "type": "h2",
...
},
{
  ...
  "cover": "assets/images/blog-covers/dark-patterns.svg?v=20260421b",
  "body": [
    {
      "type": "h2",
...
},
{
  ...
  "cover": "assets/images/blog-covers/ai-in-product.svg?v=20260421b",
  "body": [
    {
      "type": "h2",
...
},
{
  ...
  "cover": "assets/images/blog-covers/accessibility-checklist.svg?v=20260421b",
  "body": [
    {
      "type": "h2",
...
},
{
  ...
  "cover": "assets/images/blog-covers/ux-onboarding.svg?v=20260421b",
  "body": [
    {
      "type": "h2",
...
},
{
  ...
  "cover": "assets/images/blog-covers/pricing-ux.svg?v=20260421b",
  "body": [
    {
      "type": "h2",
...
},
{
  ...
  cover: "assets/images/blog-covers/ux-audit.svg?v=20260421b",
  body: [
    {
      type: "h2",
...
},
{
  ...
  cover: "assets/images/blog-covers/design-system-scale.svg?v=20260421b",
  body: [
    {
      type: "h2",
...
},
{
  ...
  cover: "assets/images/blog-covers/activation-metrics.svg?v=20260421b",
  body: [
    {
      type: "h2",
...
const experience = [
  {
    role: "Head of UX/UI в компании Mirox",
    dates: "15.09.2025 - 02.02.2026",
    details: [
      "Руководил UX/UI направлением в продуктах компании: многостраничные сайты, Telegram Mini App и внутренняя платформа для креаторов.",
      "Проектировал архитектуру и пользовательские сценарии сайтов: структура, навигация, ключевые пользовательские потоки.",
      "Разрабатывал UX/UI для Telegram Mini App с учетом ограничений платформы и мобильного формата.",
      "Участвовал в проектировании и развитии платформы для креаторов: личные кабинеты, дашборды и функциональные модули.",
      "Создавал брендбуки и гайдлайны: визуальный язык, типографика, цветовые системы и правила использования компонентов.",
      "Формировал визуальный стиль компании для социальных сетей: шаблоны, визуальные паттерны и единый tone of visual.",
      "Выстраивал единые дизайн-стандарты для всех продуктов, обеспечивая консистентность UX/UI между платформами.",
      "Результат: обеспечил целостный визуальный и пользовательский опыт между сайтами, продуктами и соцсетями.",
      "Результат: снизил хаос в дизайне за счет внедрения брендбуков и гайдлайнов.",
      "Результат: подготовил основу для масштабирования продуктов и команд без потери качества интерфейсов."
    ]
  },
  {
    role: "Ведущий UX/UI дизайнер в компании Octoclick",
    dates: "16.10.2024 - 10.09.2025",
    details: [
      "Разрабатывал и улучшал интерфейсы рекламной платформы: управление кампаниями, аналитика, настройки и отчеты.",
      "Улучшал пользовательский опыт на основе бизнес-логики продукта и потребностей пользователей.",
      "Проектировал сложные интерфейсы: дашборды, многоуровневые фильтры, таблицы, формы и многофункциональные элементы.",
      "Развивал UI-kit на базе Ant Design: стандартизация компонентов, рост консистентности и ускорение разработки.",
      "Вел продуктовые задачи от постановки до передачи в разработку: макеты, спецификации, состояния и адаптивы.",
      "Результат: повысил целостность интерфейса и качество пользовательских сценариев в продукте.",
      "Результат: ускорил работу команды благодаря систематизации компонентов и повторно используемых решений.",
      "https://octoclick.com/ru",
      "https://panel.octoclick.com/sign-in/"
    ]
  },
  {
    ...
    details: [
      "Разработал и внедрил учебную программу по UX/UI дизайну: структура курса, логика развития навыков и практические блоки.",
      "Создал единую дизайн-систему для внутренних образовательных ресурсов и материалов.",
      "Разработал практические задания, приближенные к продуктовой работе: макеты, UI-компоненты, сценарии и прототипы.",
      "Подготовил лекционные материалы и теоретическую базу: UX, UI, типографика, композиция, дизайн-системы, продуктовый подход.",
      "Контролировал качество проведения занятий и сопровождал студентов по проектам.",
      "Нанимал, обучал и курировал преподавателей, выстраивал единые стандарты преподавания.",
      "Проводил открытые вебинары и публичные мероприятия.",
      "Результат: сформировал устойчивую систему обучения, которую можно масштабировать через преподавателей и единый контент.",
      "Результат: повысил качество образовательного продукта через стандартизацию материалов и контроль преподавания.",
      "https://code-edu.ru/"
    ]
  },
  {
    role: "UX/UI дизайнер в индонезийской компании «Orbita»",
    dates: "10.08.2023 - 10.10.2024",
    details: [
      "Разрабатывал дизайн для сайта и маркетинговых материалов компании.",
      "Масштабировал существующий веб-дизайн: внедрял новые страницы и расширял структуру.",
      "Создавал презентации для англоязычной аудитории: структура, визуальный стиль и подача смысла.",
      "Работал над визуальной коммуникацией мероприятий и инфоповодов: UI-материалы, промо-страницы, графика.",
      "Результат: улучшил визуальную целостность бренда и качество коммуникации с англоязычной аудиторией.",
      "Результат: расширил сайт новыми страницами без потери стилистики и логики.",
      "https://orbita.investments/"
    ]
  },
  {
    role: "UX/UI дизайнер Кубанского государственного аграрного университета",
    dates: "10.06.2023 - 10.09.2024",
    details: [
      "Разрабатывал внутренние образовательные продукты университета.",
      "Улучшал UX внутренних страниц и интерфейсов официального сайта.",
      "Создавал UI-материалы для освещения мероприятий и новостей.",
      "Работал на стыке дизайна и разработки с учетом технических ограничений и требований.",
      "Результат: улучшил качество внутренних веб-ресурсов и удобство пользовательских сценариев."
    ]
  }
];
