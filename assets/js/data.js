...
const caseStudies = {
  octoclick: {
    title: "Octoclick",
    subtitle: "Advertising platform redesign",
    tags: ["AdTech", "Dashboard", "Design System"],
    task: "Провести комплексный редизайн рекламной платформы, повысить скорость работы с аналитикой и заложить основу для масштабируемой дизайн‑системы. Основные вызовы — плотные отчёты, много метрик и необходимость привести разрозненные сценарии к единой логике.",
    whatDone: [
      "Пересобрал структуру продукта и ключевые сценарии (кампании, отчётность, настройки, финансы).",
      "Редизайнил 60+ экранов с фокусом на читабельность данных и приоритеты.",
      "Собрал систему компонентов и правила использования для быстрого масштабирования.",
      "Продумал адаптивность и сложные edge‑cases для аналитики и таблиц.",
      "Сделал маркетинговые поверхности: сайты octoclick.com, octocpa.com и блог octoblog.com.",
      "Обновил визуальный язык, сохранив строгий характер продукта."
    ],
    metrics: [
      "Сократили время выполнения ключевых операций по данным UX‑тестов.",
      "Упростили навигацию и снизили нагрузку на поддержку.",
      "Ускорили разработку за счёт повторно используемых паттернов и единого UI‑кита.",
      "Обновили визуальный образ платформы и повысили консистентность интерфейса.",
      "Рост клиентских показателей и повторных запусков кампаний."
    ],
    links: [
  ...
  visiflow: {
    title: "VISI FLOW",
    subtitle: "AI-powered construction documentation",
    tags: ["AI", "B2B", "Workflow"],
    task: "Создать строгий, но удобный интерфейс для конвертации строительной документации с помощью AI, где ключевое — точность, контроль и быстрые сценарии проверки.",
    whatDone: [
      "Собрал информационную архитектуру и сценарии: загрузка, обработка, проверка, экспорт.",
      "Сделал 40+ экранов и интерактивные прототипы для ключевых ролей.",
      "Оптимизировал сложные рабочие процессы через пошаговые панели и статусы.",
      "Продумал плотные таблицы, сравнение версий и контроль качества результатов.",
      "Настроил строгий визуальный язык с фокусом на точность и читаемость.",
      "Учёл отраслевые требования к аккуратной работе с документами и регламентами."
    ],
    metrics: [
      "Снижение количества шагов в ключевых сценариях.",
      "Сокращение ошибок при проверке документации.",
      "Рост удовлетворённости пользователей (NPS)."
    ],
